...
type Storage struct {
	...
	Driver Storage_Driver `protobuf:"varint,1,opt,name=driver,proto3,enum=grpcservice.laptop.Storage_Driver" json:"driver,omitempty"`
...
var file_storage_message_proto_rawDesc = []byte{
	...
	0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x12, 0x67, 0x72, 0x70, 0x63, 0x73, 0x65, 0x72,
	0x76, 0x69, 0x63, 0x65, 0x2e, 0x6c, 0x61, 0x70, 0x74, 0x6f, 0x70, 0x1a, 0x14, 0x6d, 0x65, 0x6d,
	...
	0x67, 0x72, 0x70, 0x63, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x2e, 0x6c, 0x61, 0x70, 0x74,
	0x6f, 0x70, 0x2e, 0x53, 0x74, 0x6f, 0x72, 0x61, 0x67, 0x65, 0x2e, 0x44, 0x72, 0x69, 0x76, 0x65,
	...
	0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x2e, 0x6c, 0x61, 0x70, 0x74, 0x6f, 0x70, 0x2e, 0x4d,
...
var file_storage_message_proto_goTypes = []any{
	(Storage_Driver)(0), // 0: grpcservice.laptop.Storage.Driver
	(*Storage)(nil),     // 1: grpcservice.laptop.Storage
	(*Memory)(nil),      // 2: grpcservice.laptop.Memory
}
var file_storage_message_proto_depIdxs = []int32{
	0, // 0: grpcservice.laptop.Storage.driver:type_name -> grpcservice.laptop.Storage.Driver
	2, // 1: grpcservice.laptop.Storage.memory:type_name -> grpcservice.laptop.Memory
