...
type Memory struct {
	...
	Unit  Memory_Unit `protobuf:"varint,2,opt,name=unit,proto3,enum=grpcservice.laptop.Memory_Unit" json:"unit,omitempty"`
}
...
var file_memory_message_proto_rawDesc = []byte{
	...
	0x69, 0x63, 0x65, 0x2e, 0x6c, 0x61, 0x70, 0x74, 0x6f, 0x70, 0x22, 0xb3, 0x01, 0x0a, 0x06, 0x4d,
...
var file_memory_message_proto_goTypes = []any{
	(Memory_Unit)(0), // 0: grpcservice.laptop.Memory.Unit
	(*Memory)(nil),   // 1: grpcservice.laptop.Memory
}
var file_memory_message_proto_depIdxs = []int32{
	0, // 0: grpcservice.laptop.Memory.unit:type_name -> grpcservice.laptop.Memory.Unit
