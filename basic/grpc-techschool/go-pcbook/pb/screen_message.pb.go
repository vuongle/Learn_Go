...
type Screen struct {
	...
	Panel      Screen_Panel       `protobuf:"varint,3,opt,name=panel,proto3,enum=grpcservice.laptop.Screen_Panel" json:"panel,omitempty"`
...
var file_screen_message_proto_rawDesc = []byte{
	...
	0x69, 0x63, 0x65, 0x2e, 0x6c, 0x61, 0x70, 0x74, 0x6f, 0x70, 0x22, 0xa9, 0x02, 0x0a, 0x06, 0x53,
	...
	0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x25, 0x2e, 0x67, 0x72, 0x70, 0x63, 0x73, 0x65, 0x72,
	0x76, 0x69, 0x63, 0x65, 0x2e, 0x6c, 0x61, 0x70, 0x74, 0x6f, 0x70, 0x2e, 0x53, 0x63, 0x72, 0x65,
	...
	0x65, 0x6c, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x20, 0x2e, 0x67, 0x72, 0x70, 0x63, 0x73,
	0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x2e, 0x6c, 0x61, 0x70, 0x74, 0x6f, 0x70, 0x2e, 0x53, 0x63,
...
var file_screen_message_proto_goTypes = []any{
	(Screen_Panel)(0),         // 0: grpcservice.laptop.Screen.Panel
	(*Screen)(nil),            // 1: grpcservice.laptop.Screen
	(*Screen_Resolution)(nil), // 2: grpcservice.laptop.Screen.Resolution
}
var file_screen_message_proto_depIdxs = []int32{
	2, // 0: grpcservice.laptop.Screen.resolution:type_name -> grpcservice.laptop.Screen.Resolution
	0, // 1: grpcservice.laptop.Screen.panel:type_name -> grpcservice.laptop.Screen.Panel
