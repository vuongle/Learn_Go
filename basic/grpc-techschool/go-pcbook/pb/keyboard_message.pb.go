...
type Keyboard struct {
	...
	Layout  Keyboard_Layout `protobuf:"varint,1,opt,name=layout,proto3,enum=grpcservice.laptop.Keyboard_Layout" json:"layout,omitempty"`
...
var file_keyboard_message_proto_rawDesc = []byte{
	...
	0x67, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x12, 0x67, 0x72, 0x70, 0x63, 0x73, 0x65,
	0x72, 0x76, 0x69, 0x63, 0x65, 0x2e, 0x6c, 0x61, 0x70, 0x74, 0x6f, 0x70, 0x22, 0x9c, 0x01, 0x0a,
	...
	0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x2e, 0x6c, 0x61, 0x70, 0x74, 0x6f, 0x70, 0x2e, 0x4b,
...
var file_keyboard_message_proto_goTypes = []any{
	(Keyboard_Layout)(0), // 0: grpcservice.laptop.Keyboard.Layout
	(*Keyboard)(nil),     // 1: grpcservice.laptop.Keyboard
}
var file_keyboard_message_proto_depIdxs = []int32{
	0, // 0: grpcservice.laptop.Keyboard.layout:type_name -> grpcservice.laptop.Keyboard.Layout
